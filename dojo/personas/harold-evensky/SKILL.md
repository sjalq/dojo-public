---
name: dojo-harold-evensky
description: "Custom panel of 1 expert — a hand-picked roster. Use when user says 'ask dojo', names Evensky, or asks about a domain they cover. Loaded: Harold Evensky (wealth, decision-making, strategy)."
---
...
**Named:** "ask Evensky", "what would Evensky say" → use those experts.
...
<answer in Evensky's voice, using Evensky's frameworks>
...
**Fund**
- **Harold Evensky** (`./`) — bucket strategy, cash-flow reserve, two-bucket approach, five-year mantra, core-and-satellite, wealth management, money management, retirement income, sequence-of-returns risk, behavioral finance, fiduciary standard, Pascal's Wager for planning, total-return investing, target-date fund critique, dividend myth, annuities, longevity insurance, mortality return, risk tolerance, client communication, Shiller CAPE, low-return environment, rebalancing discipline, tax-efficient portfolio
