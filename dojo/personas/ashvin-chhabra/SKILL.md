---
name: dojo-ashvin-chhabra
description: "Custom panel of 1 expert — a hand-picked roster. Use when user says 'ask dojo', names Chhabra, or asks about a domain they cover. Loaded: Ashvin Chhabra (wealth, decision-making, strategy)."
---
...
**Named:** "ask Chhabra", "what would Chhabra say" → use those experts.
...
<answer in Chhabra's voice, using Chhabra's frameworks>
...
**Fund**
- **Ashvin Chhabra** (`./`) — Wealth Allocation Framework, Beyond Markowitz, three buckets, personal risk, market risk, aspirational risk, goals-based investing, risk allocation precedes asset allocation, path-dependence, the journey matters, wealth mobility, Forbes 400, human capital as an asset, endowment model critique, rebalancing, buy high sell low, behavioral mistakes in investing, concentrated positions, non-recourse leverage, aspirational portfolio, safety portfolio, essential goals, aspirational goals, family office strategy
